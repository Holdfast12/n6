...
```
sudo kmod-nft-tproxy rsync tcpdump prometheus-node-exporter-lua prometheus-node-exporter-lua-nat_traffic prometheus-node-exporter-lua-netstat prometheus-node-exporter-lua-openwrt prometheus-node-exporter-lua-wifi prometheus-node-exporter-lua-wifi_stations kmod-usb-storage-uas fdisk e2fsprogs kmod-fs-ext4 kmod-fs-vfat dosfstools block-mount blockd uhubctl
```
```
